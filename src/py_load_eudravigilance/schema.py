...
icsr_master = sqlalchemy.Table(
    ...
    sqlalchemy.Column("receiveridentifier", sqlalchemy.String(255)),
    # C.2 Section
    sqlalchemy.Column("reportercountry", sqlalchemy.String(255)),
    sqlalchemy.Column("qualification", sqlalchemy.String(255)),
    sqlalchemy.Column(
